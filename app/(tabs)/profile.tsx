...
const menuItems = [
  { id: "1", icon: "🏠", label: "My Listings", screen: "listings" },
  { id: "2", icon: "💬", label: "My Chats", screen: "messages" },
  { id: "3", icon: "💰", label: "Deposit History", screen: "deposits" },
  { id: "4", icon: "🚨", label: "Reported Listings", screen: "reports" },
  { id: "5", icon: "🔔", label: "Notifications", screen: "notifications" },
  { id: "6", icon: "⚙️", label: "Settings", screen: "settings" },
  { id: "7", icon: "❓", label: "Help & Support", screen: "help" },
];
